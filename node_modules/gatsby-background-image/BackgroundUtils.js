...
exports.default = exports.getBackgroundStylesForSingleClass = exports.getStyleRules = exports.toCamelCase = exports.rulesForCssText = exports.getStyle = void 0;
  ...
  for (let i = 0; i < styleSheets.length; i++) {
    ...
    for (let x = 0; x < classes.length; x++) {
      if (classes[x].selectorText === className) {
        ...
        return ret.indexOf(classes[x].selectorText) === -1 ? `${classes[x].selectorText}{${ret}}` : ret;
      }
    }
  }
};
...
const rulesForCssText = styleContent => {
...
const toCamelCase = str => typeof str === 'string' && str.toLowerCase().replace(/(?:^\w|-|[A-Z]|\b\w)/g, (letter, index) => index === 0 ? letter.toLowerCase() : letter.toUpperCase()).replace(/\s|\W+/g, '');
/**
